...
public class PurchaseOrderItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_PurchaseOrder_poNumber_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_PurchaseOrder_poNumber_feature", "_UI_PurchaseOrder_type"),
				 PoPackage.Literals.PURCHASE_ORDER__PO_NUMBER,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((PurchaseOrder)object).getPoNumber();
