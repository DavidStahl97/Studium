package inf.thm.de.entities.ide.contentassist.antlr.internal;
...
public class InternalEntitiesParser extends AbstractInternalContentAssistParser {
    ...
    // InternalEntities.g:248:1: rule__EntityType__EntityAlternatives_0 : ( ( 'string' ) | ( 'int' ) | ( 'boolean' ) );
        ...
        try {
            ...
            switch (alt3) {
                case 1 :
                    ...
                    {
                     before(grammarAccess.getEntityTypeAccess().getEntityStringKeyword_0_0()); 
                    match(input,11,FOLLOW_2); 
                     after(grammarAccess.getEntityTypeAccess().getEntityStringKeyword_0_0()); 
                ...
                case 2 :
                    ...
                    {
                     before(grammarAccess.getEntityTypeAccess().getEntityIntKeyword_0_1()); 
                    match(input,12,FOLLOW_2); 
                     after(grammarAccess.getEntityTypeAccess().getEntityIntKeyword_0_1()); 
                ...
                case 3 :
                    ...
                    {
                     before(grammarAccess.getEntityTypeAccess().getEntityBooleanKeyword_0_2()); 
                    match(input,13,FOLLOW_2); 
                     after(grammarAccess.getEntityTypeAccess().getEntityBooleanKeyword_0_2()); 
    ...
    // InternalEntities.g:850:1: rule__EntityType__EntityAssignment : ( ( rule__EntityType__EntityAlternatives_0 ) ) ;
    public final void rule__EntityType__EntityAssignment() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalEntities.g:854:1: ( ( ( rule__EntityType__EntityAlternatives_0 ) ) )
            // InternalEntities.g:855:2: ( ( rule__EntityType__EntityAlternatives_0 ) )
            {
            // InternalEntities.g:855:2: ( ( rule__EntityType__EntityAlternatives_0 ) )
            // InternalEntities.g:856:3: ( rule__EntityType__EntityAlternatives_0 )
            {
             before(grammarAccess.getEntityTypeAccess().getEntityAlternatives_0()); 
            // InternalEntities.g:857:3: ( rule__EntityType__EntityAlternatives_0 )
            // InternalEntities.g:857:4: rule__EntityType__EntityAlternatives_0
            {
            pushFollow(FOLLOW_2);
