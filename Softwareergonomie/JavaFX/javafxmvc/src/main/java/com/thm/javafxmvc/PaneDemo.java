...
public class PaneDemo extends Application {
    ...
    static Node createShape() {

        try {
            var inputStream = new FileInputStream("C:\\Users\\dstah\\Pictures\\Metronom.png");
            Image image = new Image(inputStream);
            var ceiling_image = new ImageView(image);

            ceiling_image.addEventFilter(MouseEvent.MOUSE_PRESSED, t -> {
                orgSceneX = t.getSceneX();
                orgTranslateX = ((ImageView)(t.getSource())).getTranslateX();
            });
            ceiling_image.setOnMouseDragged(t -> {
