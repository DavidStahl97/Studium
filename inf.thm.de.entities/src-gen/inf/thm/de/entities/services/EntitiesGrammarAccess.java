 ...
 */
package inf.thm.de.entities.services;
...
public class EntitiesGrammarAccess extends AbstractGrammarElementFinder {
	...
	public class ModelElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "inf.thm.de.entities.Entities.Model");
	...
	public class EntityElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "inf.thm.de.entities.Entities.Entity");
	...
	public class AttributeElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "inf.thm.de.entities.Entities.Attribute");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class AttributeTypeElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "inf.thm.de.entities.Entities.AttributeType");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class ElementTypeElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "inf.thm.de.entities.Entities.ElementType");
	...
	public class EntityTypeElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "inf.thm.de.entities.Entities.EntityType");
		...
		private final Keyword cEntityStringKeyword_0_0 = (Keyword)cEntityAlternatives_0.eContents().get(0);
		private final Keyword cEntityIntKeyword_0_1 = (Keyword)cEntityAlternatives_0.eContents().get(1);
		private final Keyword cEntityBooleanKeyword_0_2 = (Keyword)cEntityAlternatives_0.eContents().get(2);
		...
		//'string'
		public Keyword getEntityStringKeyword_0_0() { return cEntityStringKeyword_0_0; }
		
		//'int'
		public Keyword getEntityIntKeyword_0_1() { return cEntityIntKeyword_0_1; }
		
		//'boolean'
		public Keyword getEntityBooleanKeyword_0_2() { return cEntityBooleanKeyword_0_2; }
	}
	public class BasicTypeElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "inf.thm.de.entities.Entities.BasicType");
		private final Assignment cEntityAssignment = (Assignment)rule.eContents().get(1);
	...
	protected Grammar internalFindGrammar(GrammarProvider grammarProvider) {
		...
		while (grammar != null) {
			if ("inf.thm.de.entities.Entities".equals(grammar.getName())) {
				return grammar;
			}
