package inf.thm.de.entities.parser.antlr.internal;
...
public class InternalEntitiesParser extends AbstractInternalAntlrParser {
            	...
            	case 1 :
            	    ...
            	    state._fsp--;
            	    				...
            	    				add(
            	    					...
            	    					"entities",
            	    					lv_entities_0_0,
            	    					"inf.thm.de.entities.Entities.Entity");
            	...
            	case 1 :
            	    ...
            	    state._fsp--;
            	    					...
            	    					add(
            	    						...
            	    						"attributes",
            	    						lv_attributes_5_0,
            	    						"inf.thm.de.entities.Entities.Attribute");
            	    					afterParserOrEnumRuleCall();
        ...
        try {
            ...
            state._fsp--;
            					...
            					set(
            						...
            						"type",
            						lv_type_0_0,
            						"inf.thm.de.entities.Entities.AttributeType");
            					afterParserOrEnumRuleCall();
        ...
        try {
            ...
            state._fsp--;
            					...
            					set(
            						...
            						"elementType",
            						lv_elementType_0_0,
            						"inf.thm.de.entities.Entities.ElementType");
            					afterParserOrEnumRuleCall();
    ...
    // InternalEntities.g:366:1: ruleEntityType returns [EObject current=null] : ( ( (lv_entity_0_1= 'string' | lv_entity_0_2= 'int' | lv_entity_0_3= 'boolean' ) ) ) ;
    public final EObject ruleEntityType() throws RecognitionException {
        ...
        try {
            // InternalEntities.g:372:2: ( ( ( (lv_entity_0_1= 'string' | lv_entity_0_2= 'int' | lv_entity_0_3= 'boolean' ) ) ) )
            // InternalEntities.g:373:2: ( ( (lv_entity_0_1= 'string' | lv_entity_0_2= 'int' | lv_entity_0_3= 'boolean' ) ) )
            {
            // InternalEntities.g:373:2: ( ( (lv_entity_0_1= 'string' | lv_entity_0_2= 'int' | lv_entity_0_3= 'boolean' ) ) )
            // InternalEntities.g:374:3: ( (lv_entity_0_1= 'string' | lv_entity_0_2= 'int' | lv_entity_0_3= 'boolean' ) )
            {
            // InternalEntities.g:374:3: ( (lv_entity_0_1= 'string' | lv_entity_0_2= 'int' | lv_entity_0_3= 'boolean' ) )
            // InternalEntities.g:375:4: (lv_entity_0_1= 'string' | lv_entity_0_2= 'int' | lv_entity_0_3= 'boolean' )
            {
            // InternalEntities.g:375:4: (lv_entity_0_1= 'string' | lv_entity_0_2= 'int' | lv_entity_0_3= 'boolean' )
            int alt7=3;
            switch ( input.LA(1) ) {
            ...
            switch (alt7) {
                case 1 :
                    // InternalEntities.g:376:5: lv_entity_0_1= 'string'
                    {
                    lv_entity_0_1=(Token)match(input,18,FOLLOW_2); 

                    					newLeafNode(lv_entity_0_1, grammarAccess.getEntityTypeAccess().getEntityStringKeyword_0_0());
                    ...
                    break;
                case 2 :
                    // InternalEntities.g:387:5: lv_entity_0_2= 'int'
                    {
                    lv_entity_0_2=(Token)match(input,19,FOLLOW_2); 

                    					newLeafNode(lv_entity_0_2, grammarAccess.getEntityTypeAccess().getEntityIntKeyword_0_1());
                    ...
                    break;
                case 3 :
                    // InternalEntities.g:398:5: lv_entity_0_3= 'boolean'
                    {
                    lv_entity_0_3=(Token)match(input,20,FOLLOW_2); 

                    					newLeafNode(lv_entity_0_3, grammarAccess.getEntityTypeAccess().getEntityBooleanKeyword_0_2());
